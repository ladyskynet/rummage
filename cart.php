			...
			<header id="header">
				...
				<div class="content">
					<br>
						...
						$sql = "select * from yardsale inner join price on yardsale.pid=price.id where promoted='c' and uid='$userid'";
						$sql2 = "select * from item inner join price on item.pid=price.id where promoted='c' and uid='$userid'";
