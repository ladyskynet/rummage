						...
						<!-- Intro -->
							<article id="create">
								...
								<form action="create.php" method="post">
									...
									City: <input type="text" name"city" maxlength="20" required><br>
									State: <input type="text" name="state" maxlength="2" required><br>
									Zip: <input type="text" name="zip" maxlength="5" required><br>
									...
									Date/Time: <br> <input type="datetime-local" name="eventdate" style="font-color: black" required><br><br>
									<input type="submit">
								</form>	
							</article>
								...
								<?php
							 	foreach ($_SESSION['salearray'] as &$value){
									...
									echo 'Type : ' . $value['type'] . "<br>" ;
						 			echo 'Event Date/Time: ' . $value['eventdate'] . "<br>";
